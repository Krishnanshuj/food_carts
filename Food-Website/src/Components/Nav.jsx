...
let items=useSelector(state=>state.cart)
    ...
    return(
        ...
        <MdFastfood className="w-[30px] h-[30px] text-green-500" /> 
         ...
         <form className="w-[40%] h-[60px] bg-white flex items-center px-5 gap-5 rounded-md shadow-xl md:[w-70%]" onSubmit={(e)=>e.preventDefault()}>
            <IoIosSearch className="w-[30px] h-[30px] text-green-500"/>
